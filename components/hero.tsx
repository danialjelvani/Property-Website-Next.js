      ...
      <section className="linkbuttongreen md:py-20 pt-8 pb-7 [mask-image:linear-gradient(to_bottom,black_90%,transparent_100%)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center">
          <div className="text-center">
            <h1 className={`text-5xl tracking-wide ${myFont.className} text-teal-200 md:text-6xl lg:text-7xl`}>
              <div className="font-Title text-xl lg:text-2xl mb-2">Find the Best at</div>Isfahan Rentals
            </h1>
