    ...
    <>
      <section className="px-4 pt-2 pb-10 linkbuttonskygray2">
        <div className="container m-auto">
          <h2 className={`xl:text-4xl text-3xl ${myFont.className} tracking-wider bg-gradient-to-b from-orange-950 via-orange-950 to-orange-900 bg-clip-text text-transparent mt-7 mb-8 md:mb-6 text-center`}>
            Properties
          </h2>
